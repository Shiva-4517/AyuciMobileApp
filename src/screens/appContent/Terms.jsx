    ...
    <ScrollView style={{ backgroundColor: "#EFFBFF" }}>
      ...
      <View style={{margin:20}}>
        <Text style={{fontFamily:LightTheme.light.fontRegular}}>
          ...
          related to it, still belong to Samarth Meditech. Samarth Meditech is
          ...
          very clear to you exactly what you’re paying for. The ayuci app stores
          ...
          features and it could mean that the ayuci app won’t work properly or
          ...
          that there are certain things that Samarth Meditech will not take
          ...
          provided by your mobile network provider, but Samarth Meditech cannot
          ...
          from the bill payer for using the app. Along the same lines, Samarth
          Meditech cannot always take responsibility for the way you use the app
          i.e. You need to make sure that your device stays charged – if it runs
          out of battery and you can’t turn it on to avail the Service, Samarth
          Meditech cannot accept responsibility. With respect to Samarth
          Meditech’s responsibility for your use of the app, when you’re using
          ...
          available to you. Samarth Meditech accepts no liability for any loss,
          ...
          the app. The app is currently available on Android – the requirements
          ...
          the updates if you want to keep using the app. Samarth Meditech does
          not promise that it will always update the app so that it is relevant
          to you and/or works with the Android version that you have installed
